...
ytproDownDiv.innerHTML="<style>#downytprodiv a{text-decoration:none;color:white;} #downytprodiv li{list-style:none;color:#0dd;padding:10px;background:#04B2A7;border:1px solid silver;margin:5px;text-align:lft;}</style>";
ytproDownDiv.innerHTML+="<span style='position:absolute;top:15px;left:15px;color:#04C5B9;font-size:30px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2715;</span><iframe  sandbox='allow-downloads allow-forms allow-modals allow-pointer-lock allow-presentation allow-same-origin allow-scripts allow-top-navigation-by-user-activation'  scrolling='no' src='https://loader.to/api/button/?url="+ytproURL+"&f=mp3&color=16E2F5' class='iframevkr'></iframe><ul id='listurl'>";
...
ytproAudX.style.background="black";
